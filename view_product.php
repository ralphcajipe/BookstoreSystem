...
if ($products->num_rows > 0) {
   ...
   /* This is the path of the image. */
    ...
    $img = "";
   /* Checking if the directory exists and if it does, it will get the first image in the directory. */
   ...
   /* Fetching the inventory of the product. */
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                ...
                <div class="mt-2 row gx-2 gx-lg-3 row-cols-4 row-cols-md-3 row-cols-xl-4 justify-content-start">
                    <?php
                    /* Checking if the image is not a directory. */
...
<script>
   /* Converting the php array to javascript array. */
    ...
    /* A jquery function that is executed when the page is loaded. It is used to change the image when
    ...
    $(function() {
        ...
        /* Used to change the price and quantity of the product when the user clicks on the size of the
       product. */
       ...
       /* Used to add the product to the cart. */
        $('#add-cart').submit(function(e) {
           ...
           /* A function that is used to display a loading icon. */
            start_loader();
           /* Used to send the data to the server. */
            $.ajax({
                ...
                method: 'POST',
                dataType: "json",
               /* Used to display an error message when an error occurs. */
                error: err => {
                    console.log(err)
                    alert_toast("an error occured", 'error')
                    end_loader()
                },
              /* Used to display a message when the product is added to the cart. */
