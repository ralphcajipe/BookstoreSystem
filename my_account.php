    ...
    <script>
       /* A function that is used to cancel a book. */
        function cancel_book($id) {
            start_loader()
            /* Sending a request to the server to update the status of the book. */
            $.ajax({
                ...
                dataType: "json",
                /* A function that is used to display an error message. */
                error: err => {
                    console.log(err)
               ...
               /* A function that is used to display a success message. */
                success: function(resp) {
                    ...
                    /* A function that is used to stop the loader. */
                    end_loader()
                }
            })
        }
       /* A function that is used to display a modal. */
        $(function() {
