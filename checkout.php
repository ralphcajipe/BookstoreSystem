<!-- (Discontinued) Loading the paypal checkout script. -->
...
<script>
    ...
    paypal.Button.render({
        ...
        /* This is the function that is responsible for creating the payment. */
        ...
        /* The function that is responsible for creating the payment. */
        ...
        /* The id of the button that will be clicked to trigger the payment. */
    }, '#paypal-button');

    /**
     * It sets the value of the payment method to "Online Payment" and the value of the paid field to 1,
    ...
    /* A jQuery function that is responsible for submitting the form. */
    /* A jQuery function that is responsible for hiding the address field 
    if the order type is for pick
    up. */
    $(function() {
